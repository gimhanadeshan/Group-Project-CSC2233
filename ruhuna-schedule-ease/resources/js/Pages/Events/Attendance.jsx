...
const AttendancePage = ({ auth, eventId, studentId, attendance }) => {
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.put(`/attendance/${courseType}/${eventId}/${studentId}/update`, {
            attended,
            courseType,  // Include courseType in the request
        });
    };
            ...
            >
                <div>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="attended" className="block text-sm font-medium text-gray-700">
                                Attended
                            </label>
                            <input
                                type="checkbox"
                        ...
                        <button type="submit" className="mt-4 px-4 py-2 bg-indigo-500 text-white rounded-md">
                            Update Attendance
                        </button>
                    </form>
                </div>
