...
export default function Index({
    auth,
    semestersInTimeTable,
    semestersNotInTimeTable,
}) {
    ...
    const semesterInOptions = semestersInTimeTable.map((semester) => ({
        value: semester,
        label: `Level ${semester.level} - Semester ${semester.semester} - ${semester.academic_year} - ${semester.degree_program.name}`,
    }));
        ...
        <Authenticated user={auth.user} permissions={auth.permissions}>
            ...
            <div className="container mx-auto px-4 py-6">
                <div className="flex justify-between gap-6">
                                ...
                                <Select
                                    ...
                                    theme={(theme) => ({
                                        ...
                                        colors: {
                                            ...
                                            neutral0:
                                                theme.colors.neutral0 === "#fff"
                                                    ? "#1f2937"
                                                    : theme.colors.neutral0, // dark bg
                                            neutral80:
                                                theme.colors.neutral80 ===
                                                "#333"
                                                    ? "#e5e7eb"
                                                    : theme.colors.neutral80, // light text for dark mode
                                        },
                                    })}
                                />
                            </div>
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4">
                                        <Link
                                            href={route("timetables.create", {
                                                level: selectedSemesterNotIn
                                                    .value.level,
                                                semester:
                                                    selectedSemesterNotIn.value
                                                        .semester,
                                                semester_id:
                                                    selectedSemesterNotIn.value
                                                        .id,
                    ...
                    {/* View TimeTable Form */}
                    {auth.permissions.includes("read_timetable") && (
                        <div className="w-full lg:w-1/2 bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                            <h2 className="text-2xl font-bold mb-4 text-center text-gray-900 dark:text-gray-100">
                                View a TimeTable
                            </h2>
