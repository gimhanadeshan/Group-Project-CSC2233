...
export default function Dashboard({ auth, allevents }) {
    ...
    const handleSelectSlot = (slotInfo) => {
        ...
        setSelectEvent(null);
        //setData('start', new Date( moment(selectedStart).format('YYYY-MM-DDTHH:mm')));
        //setData('end', new Date( moment(selectedEnd).format('YYYY-MM-DDTHH:mm')));
        //reset();
    };
    ...
    const saveEvent = () => {
        ...
        console.log('End='+formattedData.end);
                                        ...
                                        <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                            ...
                                            <div className="mt-2">
                                                ...
                                                <input
                                                    ...
                                                    //value={selectEvent ? moment(data.start).format('YYYY-MM-DDTHH:mm') : moment(selectedStart).format('YYYY-MM-DDTHH:mm') }
                                                    onChange={
