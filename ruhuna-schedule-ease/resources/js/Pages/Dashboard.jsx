            ...
            tooltip: {
                callbacks: {
                    label: function(context) {
                        ...
                        return `${context.dataset.label}: ${start.toDateString()} - ${end.toDateString()}`;
                    }
                }
            }
        },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-gray-100 p-4 rounded-lg shadow-sm">
                            <p className="text-sm text-gray-600">
                                <strong>Academic Year:</strong> {currentSemester.academic_year}
                            </p>
                            <p className="text-sm text-gray-600">
                                <strong>Level:</strong> {currentSemester.level}
                            </p>
                            <p className="text-sm text-gray-600">
                                <strong>Semester:</strong> {currentSemester.semester}
                            </p>
                            <p className="text-sm text-gray-600">
                                <strong>Status:</strong> {currentSemester.status}
                            </p>
                            <p className="text-sm text-gray-600">
                                <strong>Start Date:</strong> {currentSemester.start_date}
                            </p>
                            <p className="text-sm text-gray-600">
                                <strong>End Date:</strong> {currentSemester.end_date}
                            </p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg shadow-sm">
                            <h4 className="text-lg font-semibold mb-2">Semester Timeline</h4>
                            <div className="h-64">
