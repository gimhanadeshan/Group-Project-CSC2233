...
export default function Popup({ closePopup, saveSettings, initialSettings }) {
  ...
  return (
    <div className="popup fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="popup-inner bg-white p-6 rounded-md shadow-md w-full max-w-2xl">
        <h2 className="text-xl font-bold mb-4">Advanced Settings</h2>
        <div className="mb-4">
          <label className="block text-lg mb-2">Lunch Time</label>
          <input
            type="time"
            ...
            className="border rounded p-2 w-50% mb-2"
          />
          <input
            type="time"
            name="lunchTime.end"
        ...
        <div className="mb-4">
          <label className="block text-lg mb-2">Lecture Time</label>
          <input
            type="time"
        ...
        <div className="mb-4">
          <label className="block text-lg mb-2">Practical Time</label>
          <input
            type="time"
        ...
        <div className="mb-4">
          <label className="block text-lg mb-2">Free Timeslots</label>
          {settings.freeTimeslots.map((timeslot, index) => (
            <div key={index} className="mb-2">
              ...
              <button
                ...
                className="text-red-600 hover:text-red-700 focus:outline-none mb-2"
              >
                Remove
              </button>
            </div>
